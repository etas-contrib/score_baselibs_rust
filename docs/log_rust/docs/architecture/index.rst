...
.. _component_architecture_log_rust:

Log Rust Component Architecture
===============================

.. document:: Log Rust Architecture
   :id: doc__log_rust_architecture
   :status: draft
   :safety: ASIL_B
   :security: NO
...
.. comp:: log_rust
   ...
   :safety: ASIL_B
   :status: invalid
   :implements: logic_arc_int__log_rust__logging_rust
   :uses: logic_arc_int__log_rust__score_logger

..
   TEMPLATE: Uncomment and fill out the following comp_arc_sta directive:

   .. comp_arc_sta:: Log Rust (Static View)
      :id: comp_arc_sta__log_rust__static_view
      :security: YES
      :safety: ASIL_B
      :status: invalid
      :implements: logic_arc_int__log_rust__logging_rust
      :fulfils: comp_req__log_rust__some_title
      :includes: comp_arc_sta__log_rust__2
